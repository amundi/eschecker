...
import (
	...
	"github.com/amundi/escheck/queries"
...
func TestDummyYaml1(t *testing.T) {
	...
	dummy, err := hex.DecodeString("2364756d6d792079616d6c2066696c6520666f72" +
		...
		"c7465720d0a202020202020636c61757365733a0d0a20202020202020206d7573745f6e6f" +
		"743a0d0a202020202020202020202d207465726d3a205b22737461747573222c20226f6b2" +
		"25d0d0a202020202020202020202d2072616e67653a205b22636f6465222c20226c74222c" +
		"203530305d0d0a0d0a202074657374323a0d0a20202020616c6572745f6f6e6c796f6e636" +
		"53a2066616c73650d0a2020202072656d696e6465723a20333030306d0d0a202020207363" +
		"686564756c653a203330680d0a20202020616c6572745f656e646d73673a2066616c73650" +
		"d0a20202020616374696f6e733a0d0a2020202020206c6973743a205b656d61696c5d0d0a" +
		"202020202020656d61696c3a0d0a2020202020202020746f3a205b6d6f6940686f746d616" +
		"96c2e636f6d5d0d0a2020202071756572793a0d0a202020202020696e6465783a20746573" +
		"74322a0d0a202020202020736f72746f726465723a20444553430d0a202020202020736f7" +
		"27462793a2074696d657374616d700d0a2020202020206e62646f63733a203138300d0a20" +
		"20202020206c696d69743a20300d0a202020202020747970653a20626f6f6c66696c74657" +
		"20d0a202020202020636c61757365733a0d0a20202020202020206d7573743a0d0a202020" +
		"202020202020202d207465726d3a205b225365766572697479222c20355d0d0a202020202" +
		"020202073686f756c643a0d0a202020202020202020202d2072616e67653a205b2274696d" +
	...
	//email info
	assert.Equal(t, "myserver", c.Server)
	assert.Equal(t, 4242, c.Port)
	assert.Equal(t, "rob@hello.com", c.Username)
	assert.Equal(t, "secretz", c.Password)
