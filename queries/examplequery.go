...
//"github.com/amundi/escheck/esmail"
//"github.com/amundi/escheck/esslack"
...
type ExampleQuery struct {
  ...
  elasticsearch document. See the golang elastic package to learn how to get results
...
func (e *ExampleQuery) SetQueryConfig(c config.ManualQueryList) bool {
  ...
  e.mailList = c.ExampleQuery.MailList
	...
	documentation to do it. This query for example will look for statuses >= e.errorStatus in the whole
